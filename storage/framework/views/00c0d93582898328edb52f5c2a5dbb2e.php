...
<?php $__env->startSection('main'); ?>
    ...
    <form action="/confirmEditMhs" method="post" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <input type="text" name="nama" class="nama" id="nama"  value="<?php echo e($mhs->nama); ?>" disabled>
        </div>
        <div class="form-row">
            <label id="label-nim" for="nim">NIM : </label>
            <input type="number" name="nim" class="nim" id="nim"  value="<?php echo e($mhs->nim); ?>" readonly>
        </div>
        <div class="form-row">
        ...
        <div class="form-row">
            ...
            <select name="dosen_wali" id="dosen_wali" required>
                ...
                <?php $__currentLoopData = $doswal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($item->nip); ?>"><?php echo e($item->nama); ?></option>
...
<?php echo $__env->make('main_operator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppl_kelompok\resources\views/edit_mhs_operator.blade.php ENDPATH**/ ?>