    ...
    <div class="container">
      ...
      <div class="table-responsive">
        ...
        <table class="table custom-table">
          ...
          <tbody>
            <?php $__currentLoopData = $pkl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="data">
                    <td ><?php echo e($item->nama); ?></td>
                    <td ><?php echo e($item->nim); ?></td>
                    <td ><?php echo e($item->nilai_pkl); ?></td>
                    <td ><?php echo e($item->semester); ?></td>
                    <td ><a href="dokumen_ppl_projek/pkl/<?php echo e($item->scan_pkl); ?>" target="_blank" id="download">Lihat File</a></td>
                    <td>
                      <?php if($item->stat_cek == 1): ?>
                        <h4 id="sudah_disetujui" style="color: green;">Verified</h4>
                      <?php else: ?>
                        <a id="setuju1" href=<?php echo e(route('edit_validasi_pkl', ['nim' => urlencode($item->nim)])); ?> class="btn-action">Edit</a>
                        <a id="setuju" href=<?php echo e(route('setujui_pkl', ['nim' => urlencode($item->nim)])); ?> class="btn-action1">Approve</a>
                      <?php endif; ?>
                    </td>
                </tr>
...
<?php echo $__env->make('main_dosen', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppl_kelompok\resources\views/penyetujuan_pkl.blade.php ENDPATH**/ ?>