...
<?php if(session('flash_edit')): ?>
    <div id="cont_flash"><div id="flash"><?php echo e(session('flash_edit')); ?></div></div>
...
<?php elseif(session('flash_delete')): ?>
    <div id="cont_flash"><div id="flash"><?php echo e(session('flash_delete')); ?></div></div>
          ...
          <table class="table custom-table">
            ...
            <tbody>
              <?php $__currentLoopData = $mhs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr class="data">
                      <td style="text-align: left;" ><?php echo e($item->nama); ?></td>
                      <td ><?php echo e($item->nim); ?></td>
                      <td ><?php echo e($item->angkatan); ?></td>
                      <td ><?php echo e($item->status_mhs); ?></td>
                      <td>
                        <a id="edit" href=<?php echo e(route('edit_mhs_operator', ['nim' => urlencode($item->nim)])); ?> class="btn-action">Edit</a>
                        <a id="delete" href=<?php echo e(route('delete_mhs_operator', ['nim' => urlencode($item->nim)])); ?> class="btn-action1" >Delete</a>
                      </td>
                  </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('main_operator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppl_kelompok\resources\views/data_mhs_operator.blade.php ENDPATH**/ ?>