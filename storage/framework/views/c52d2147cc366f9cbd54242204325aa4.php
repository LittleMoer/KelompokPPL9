              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  ...
                  <form role="form" method="POST" action="/confirmLog">
                    ...
                    <div class="text-danger text-center mb-2"><?php echo e(session('error_akun')); ?></div>
                    <div class="text-center">
...
</html><?php /**PATH C:\xampp\htdocs\ppl_kelompok\resources\views/login.blade.php ENDPATH**/ ?>