...
<?php $__env->startSection('main1'); ?>
	...
	<div class="cont_judul">
		...
		<form action="/upload_batch_mhs" method="POST" enctype="multipart/form-data">
			...
			<label for="file_mhs" id="label_file_mhs">
				<img src="<?php echo e(asset('icon-upload.png')); ?>" alt="" width="50px" height="50px">
	...
	<?php if( session('error_file') ): ?>
		<div class="error" id="error_format"><?php echo e(session('error_file')); ?></div>
		
	<?php endif; ?>
	<?php if( session('sukses') ): ?>
		<div class="cont_sukses"><div class="success" id="success"><?php echo e(session('sukses')); ?></div></div>
		<script>
	...
	<div class="cont_cat">
		<ul>
			...
			<li style="margin-top: 10px;">Contoh : <br><img src="<?php echo e(asset('format_penulisan_batch_mhs.png')); ?>" alt="format" width="500px" height="150px"></li>
		</ul>
	</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('main_operator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppl_kelompok\resources\views/entry-mahasiswa.blade.php ENDPATH**/ ?>