    ...
    <div class="konten">
        <aside>
            ...
            <div class="nav-side menu">
                <ul type='none'>
                    <li><i><img src="<?php echo e(asset('icon-profile.png')); ?>" class="logo" alt=""></i><a href="/profile/departement">Profile</a></li>
                    <li><i><img src="<?php echo e(asset('mahasiswa.png')); ?>" class="logo" alt=""></i><a href="/rekap/pkl&skripsi">Data Mahasiswa</a></li>
                    <li><i><img src="<?php echo e(asset('statistik.png')); ?>" class="logo" alt=""></i><a href="/statistik/mhs">Statistik Mahasiswa</a></li>
                    <hr>
                </ul>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\ppl_kelompok\resources\views/main_departement.blade.php ENDPATH**/ ?>