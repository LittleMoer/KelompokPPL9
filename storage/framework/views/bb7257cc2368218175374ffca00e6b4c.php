...
<?php $__env->startSection('main'); ?>
    ...
    <hr class="pemisah-input">
        <div class="form-row">
            ...
            <span id="keterangan-status"><?php echo e(session('nim')); ?></span>
        </div>
        <hr class="pemisah-input">
        <div class="form-row">
...
<?php echo $__env->make('main_mahasiswa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppl_kelompok\resources\views/informasi-pkl.blade.php ENDPATH**/ ?>