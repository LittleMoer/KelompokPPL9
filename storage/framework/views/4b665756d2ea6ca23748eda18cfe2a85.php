    ...
    <div class="konten">
        <aside>
            ...
            <div class="nav-side menu">
                ...
                <ul type='none'>
                    ...
                    <li><i><img src="<?php echo e(asset('mahasiswa.png')); ?>" class="logo" alt=""></i><a href="/data/mhs">Data Mahasiswa</a></li>
        ...
        <main>
            <div class="main_flash">
                <?php echo $__env->yieldContent('flash'); ?>
            </div>
            <div class="main1">
...
</html><?php /**PATH C:\xampp\htdocs\ppl_kelompok\resources\views/main_operator.blade.php ENDPATH**/ ?>