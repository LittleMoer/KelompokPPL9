...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var sessionData = <?php echo json_encode([
        'sudahpkl' => [], 'belumpkl' => [], // Add other necessary data here
    ]) ?>;

    <?php $__currentLoopData = range($currentYear - 6, $currentYear); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        sessionData['sudahpkl<?php echo e($year); ?>'] = '<?php echo e(session("sudahpkl" . $year)); ?>';
        sessionData['belumpkl<?php echo e($year); ?>'] = '<?php echo e(session("belumpkl" . $year)); ?>';
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

    var sessionData1 = <?php echo json_encode([
        'sudahskripsi' => [], 'belumskripsi' => [], // Add other necessary data here
    ]) ?>;

    <?php $__currentLoopData = range($currentYear - 6, $currentYear); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        sessionData1['sudahskripsi<?php echo e($year); ?>'] = '<?php echo e(session("sudahskripsi" . $year)); ?>';
        sessionData1['belumskripsi<?php echo e($year); ?>'] = '<?php echo e(session("belumskripsi" . $year)); ?>';
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('main_departement', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppl_kelompok\resources\views/rekap_pkl.blade.php ENDPATH**/ ?>