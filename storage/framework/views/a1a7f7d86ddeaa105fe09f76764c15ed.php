...
<div class="konten1">
    ...
    <div class="container-foto"><img id="foto-profile" src="<?php echo e(asset('icon-profile2.png')); ?>" alt="" width="400px" height="400px"></div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('main_departement', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppl_kelompok\resources\views/profile_dept.blade.php ENDPATH**/ ?>